...
import by.goncharov.homestart.adapters.DeviceDiscoveryListAdapter
...
import by.goncharov.homestart.helpers.UPnPDevice
import by.goncharov.homestart.helpers.UPnPDiscovery
...
class SearchDevicesActivity : AppCompatActivity(), RecyclerViewHelperInterface {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapter = DeviceDiscoveryListAdapter(
            arrayListOf(
                ListViewItem(
