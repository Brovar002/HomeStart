...
import by.goncharov.homestart.adapters.MainListAdapter
...
import by.goncharov.homestart.helpers.Global.checkNetwork
import by.goncharov.homestart.helpers.Pref
import by.goncharov.homestart.helpers.TasmotaHelper
...
class MainActivity : AppCompatActivity() {
    ...
    private fun getThemeId(): String =
        PreferenceManager.getDefaultSharedPreferences(this)
            .getString(Pref.PREF_THEME, Pref.PREF_THEME_DEFAULT) ?: Pref.PREF_THEME_DEFAULT
